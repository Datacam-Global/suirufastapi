...
from hate_speech_detector import CameroonHateSpeechDetector, HateSpeechResult, MisinformationAnalyzer
...
@app.post("/misinformation/analyze", response_model=MisinformationResponse)
async def analyze_misinformation(request: MisinformationRequest):
    """
    Analyze a single text for misinformation using Azure OpenAI
    """
